...
class ScorbotController:
    ...
    def conectar_robot(self, port):
        try:
            ...
            messagebox.showinfo(message="Conexión exitosa con el robot Scorbot.")
        except Exception as e:
            messagebox.showerror(message=f"Error al conectar con el robot Scorbot: {e}")
    ...
    def desconectar_robot(self):
        try:
            ...
            if self.serial_port and self.serial_port.isOpen():
                ...
                messagebox.showinfo(message="Desconexión exitosa del robot Scorbot.")
        except Exception as e:
            messagebox.showerror(message=f"Error al desconectar el robot Scorbot: {e}")
...
etiquetaTextoRecibido = tk.Label(ventana, text="Mensaje Recibido del Scorbot")
